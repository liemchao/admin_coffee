...
const navigation = (): VerticalNavItemsType => {
  return [
    ...
    {
      title: 'Thống kê tổng quan',
      icon: 'icon-park-twotone:market-analysis',
      path: '/dashboards/analytics'
    },

    {
      title: 'Thông kê lượt truy cập',
      icon: 'carbon:text-link-analysis',
      path: '/dashboards/crm'
    },

    {
      title: 'Thông kê order',
    ...
    {
      title: 'Quản lý phần tử trang',
      icon: 'fluent-mdl2:footer'

      // path: '/apps/calendar'
    },
    {
      title: 'Quản lý chùm ảnh',
      icon: 'fluent:content-settings-32-filled'
